...
//FLIGHT
insert into FLIGHT (FLIGHT_ID, InitialTime, FinalTime) values (1, '28/4/2018', '9/25/2019');
insert into FLIGHT (FLIGHT_ID, InitialTime, FinalTime) values (2, '28/4/2018', '9/4/2019');
insert into FLIGHT (FLIGHT_ID, InitialTime, FinalTime) values (3, '28/4/2018', '10/29/2019');
insert into FLIGHT (FLIGHT_ID, InitialTime, FinalTime) values (4, '21/4/2018', '9/24/2019');
insert into FLIGHT (FLIGHT_ID, InitialTime, FinalTime) values (5, '26/4/2018', '8/3/2019');
...
//STORED_IN_RELATION
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (1, 1, 1);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (2, 2, 2);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (3, 3, 3);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (4, 4, 4);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (5, 5, 5);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (6, 6, 6);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (7, 7, 7);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (8, 8, 8);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (9, 9, 9);
insert into STORED_IN_RELAITON (STORED_IN_ID, Plane_ID, Airport_ID) values (10, 10, 10);
...
//PROMOTION
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (1, 'Overhold', '31/5/2019', '10/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (2, 'Vagram', '29/5/2019', '25/7/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (3, 'Voltsillam', '10/5/2019', '30/8/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (4, 'Cardify', '21/5/2019', '3/10/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (5, 'Daltfresh', '28/5/2019', '27/7/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (6, 'Bigtax', '22/6/2019', '22/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (7, 'Sonair', '29/5/2019', '1/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (8, 'It', '27/5/2019', '8/8/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (9, 'Sub-Ex', '10/6/2019', '23/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (10, 'Flowdesk', '18/6/2019', '16/8/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (11, 'Bamity', '19/5/2019', '10/7/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (12, 'Holdlamis', '18/6/2019', '17/7/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (13, 'Asoka', '12/5/2019', '9/10/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (14, 'Stim', '9/5/2019', '20/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (15, 'Daltfresh', '28/4/2019', '21/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (16, 'Bitchip', '19/5/2019', '27/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (17, 'Konklux', '10/5/2019', '14/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (18, 'Andalax', '30/5/2019', '13/9/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (19, 'Toughjoyfax', '5/5/2019', '4/8/2019');
insert into PROMOTION (PROMOTION_ID, PromotionName, StartDate, EndDate) values (20, 'Latlux', '24/5/2019', '4/7/2019');
...
//CREDIT_CARD
insert into CREDIT_CARD (CREDIT_CARD_ID, CardNumber, CardName, ExpDate) values (1, '8215360327437779', 'Beverie Attow', '25/1/2021');
insert into CREDIT_CARD (CREDIT_CARD_ID, CardNumber, CardName, ExpDate) values (2, '6988511401853542', 'Justin Johnston', '2/11/2020');
insert into CREDIT_CARD (CREDIT_CARD_ID, CardNumber, CardName, ExpDate) values (3, '8736520420572863', 'Nikki Dwelley', '14/6/2020');
insert into CREDIT_CARD (CREDIT_CARD_ID, CardNumber, CardName, ExpDate) values (4, '9266078654414561', 'Jenifer Greeson', '10/3/2021');
insert into CREDIT_CARD (CREDIT_CARD_ID, CardNumber, CardName, ExpDate) values (5, '2864236795311404', 'Norbert Delaprelle', '19/10/2020');
